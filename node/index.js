...
const UUID = "a5ee0001-5246-4fc1-bd8c-e9e6067291c6" || generateUUID();
const DOMAIN = process.env.DOMAIN || 'scattered-annabelle-us-cloud-54a28f9d.koyeb.app';       // 填写项目域名
const WSPATH = process.env.WSPATH || UUID.slice(0, 8);     // 节点路径，默认获取uuid前8位
const SUB_PATH = process.env.SUB_PATH || 'sub';            // 获取节点的订阅路径
const NAME = process.env.NAME || '';                       // 节点名称
const PORT = process.env.PORT || 80;                // http和ws服务端口
const TLS_KEY_PATH = process.env.TLS_KEY_PATH || '/node/tls.key';
const TLS_CERT_PATH = process.env.TLS_CERT_PATH || '/node/tls.crt'; 
